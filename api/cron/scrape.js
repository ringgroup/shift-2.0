...
const FEED_URLS = [
  ...
  '/api/dvids?type=news&theater=centcom',
  '/api/dvids?type=image&theater=centcom',
  '/api/dvids?type=news&theater=eucom',
  '/api/dvids?type=image&theater=eucom',
  '/api/dvids?type=news&theater=indopacom',
  '/api/dvids?type=image&theater=indopacom',
  '/api/dvids?type=news&theater=africom',
  '/api/dvids?type=image&theater=africom',
  '/api/dvids?type=video&theater=centcom',
  '/api/dvids?type=video&theater=eucom',
  '/api/dvids?type=video&theater=indopacom',
  '/api/dvids?type=video&theater=africom',
  // Non-DVIDS defense sources
  'https://news.usni.org/feed',
  'https://news.google.com/rss/search?q=site:stripes.com+(Middle+East+OR+CENTCOM+OR+Iran+OR+Israel+OR+Ukraine)&when:2d&hl=en-US&gl=US&ceid=US:en',
  'https://news.google.com/rss/search?q=site:defensenews.com+(CENTCOM+OR+Iran+OR+Israel+OR+Saudi+OR+Ukraine+OR+China+OR+Taiwan)&when:2d&hl=en-US&gl=US&ceid=US:en',
